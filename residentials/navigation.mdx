...
Leep in mind that you **only **need to have the country parameter for your proxies. Other parameters are optional and can be enabled on-demand. However, the more specific you chose the region the more the chance might be that the region has less proxies.
