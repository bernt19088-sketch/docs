...
proxies = {
    'http': 'http://client-YOUR_CLIENT-country-Germany-state-landberlin-city-berlin-session-fnzwtath:YOUR_PASSWORD@residential.roundproxies.com:5000',
    'https': 'http://client-YOUR_CLIENT-country-Germany-state-landberlin-city-berlin-session-fnzwtath:YOUR_PASSWORD@residential.roundproxies.com:5000'
}
